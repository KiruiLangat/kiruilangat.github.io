    ...
    <div className='landingPageContainer' style={style}>
      ...
      <div className='landingContent'>
        <div className='techStack'>
          ...
          <StackIcon name="github" style={{background:'#ffffffb5', borderRadius:'50px'}}  className='techIcon' data-name="GitHub" />
        ...
        <div className='moreStacks2'>
          ...
          <img src={Cpanel} className='cpanel' alt="cPanel" data-name="cPanel" loading="lazy" />
          <img src={WooCommerce} className='woocommerce' alt="WooCommerce" data-name="WooCommerce" loading="lazy" />
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className='stripe' data-name="Stripe">
